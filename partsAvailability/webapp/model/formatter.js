	...
	return {
		...
		try {
			...
			if ( this.sCurrentLocale == 'EN') {
			 ...
			 var usingLocaleNumber = (new Intl.NumberFormat(sCurrentLocale, { maximumSignificantDigits: 8 }).format(value));	
		//	var sCurrentLocale = 'us-EN';
	    ...
	    price: function(value) {
	    		...
	    		try {
	    			...
	    			var priceInLocalFormat = (new Intl.NumberFormat(sCurrentLocale, {  currency: 'CAD' }).format(value));
